...
export default class UserListComponent extends NucleusComponentBase {
    ...
    get headers() {
        return [
            { text: this.$t('MeasurementDegree'), value: 'userName' },
            { text: this.$t('MeasurementDescription'), value: 'email' },
            { text: this.$t('StartTime'), value: 'userName'},
            { text: this.$t('FinishTime'), value: 'userName'},
